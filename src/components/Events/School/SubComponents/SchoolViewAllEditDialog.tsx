...
interface SchoolViewAllEditEventDialogProps {
    event: Event | null;
    onClose: () => void;
...
export function SchoolViewAllEditEventDialog({ event, onClose, onSave, isLoading, isOpen }: SchoolViewAllEditEventDialogProps) {
