...
interface CommunityViewAllEditEventDialogProps {
    event: Event | null;
    onClose: () => void;
...
export function CommunityViewAllEditEventDialog({ event, onClose, onSave, isLoading, isOpen }: CommunityViewAllEditEventDialogProps) {
