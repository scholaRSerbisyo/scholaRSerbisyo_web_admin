...
export function EventSection({ title, events, isLoading, onEventSelect }: EventSectionProps) {
    ...
    return (
        <section className={`space-y-4 border rounded-lg ${theme == 'light' ? 'border-gray-300' : ''} w-full overflow-hidden`}>
            <div className={`${headerColorClass} text-primary-foreground p-3 rounded-t-lg`}>
            ...
            <div className="relative w-full overflow-hidden">
                ...
                {events && events.length > 4 && (
                    <div className="absolute right-0 top-0 bottom-0 mb-3 w-[100px] flex items-center justify-center bg-gradient-to-l from-background to-transparent">
                        <Button 
                            variant="secondary" 
