...
export const columns: ColumnDef<Payment>[] = [
    ...
    },
    {
        ...
        header: () => <div className="text-right">No. of Return Service</div>,
        cell: ({ row }) => {
...
export function CompleteListSubComponent() {
    ...
    return (
        <div className="flex flex-col gap-6 max-w-auto overflow-x-auto">
